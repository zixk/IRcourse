 ...
 * <p>
 * You can add your feature into a learned model by appending DSM:uk.ac.gla.IRcourse.DominikBladekAvgDistFeatureDSM to the features.list file.
 * @author Dominik Bladek - 2144751b
 */
public class DominikBladekAvgDistFeatureDSM extends DependenceScoreModifier {
		...
		)
	{
		...
		/** Calculates the average distances and stores them in a list */
		...
		/** Gets the average of the average distances */
		double sum = 0;
